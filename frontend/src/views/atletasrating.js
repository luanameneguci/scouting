...
export default function AtletasRating() {
  ...
  const fetchAtletas = async (page = 1) => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8080/atleta/listarPorRating?page=${page}&size=10`,
        {
          method: "GET",
          credentials: "include",  
        }
  ...
  return (
    <div className="atletas-page">
      <h1 className="TituloEquipas">Atletas com maior rating</h1>
