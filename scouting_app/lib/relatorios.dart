  ...
  Future<void> _fetchReports() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          reports =
              fetchedReports; // Atualiza a lista de relatórios com os dados da API
        });
      } else {
        // Caso a resposta da API não seja 200
        print(
            'Erro ao carregar os relatórios. Status code: ${response.statusCode}');
      }
    } catch (e) {
      // Erro na requisição
          ...
          children: [
            ...
            Expanded(
              child: reports.isEmpty
                  ? Center(
                      child:
                          CircularProgressIndicator()) // Exibe um loading enquanto os relatórios não são carregados
                  : ListView.builder(
